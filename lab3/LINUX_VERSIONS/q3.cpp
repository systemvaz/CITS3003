...
display( void )
{
    ...
    multipliers_mat = mat3(vec3(cos(timeParam * 0.0001),
                               -sin(timeParam * 0.0005),
                               -sin(timeParam * 0)),
                           vec3(sin(timeParam * 0.0001),
                                cos(timeParam * 0.0005),
                                sin(timeParam * 0)),
                           vec3(sin(timeParam * 0),
                                sin(timeParam * 0),
                                cos(timeParam * 0)));

    glUniformMatrix3fv(multipliers, 1, GL_TRUE, multipliers_mat);
