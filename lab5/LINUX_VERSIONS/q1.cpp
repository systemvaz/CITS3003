...
display( void )
{
    ...
    drawCube(combine);
    combine = Translate(-0.25, 0.75, 0) * Scale(0.3) *RotateX(degrees) * RotateY(degrees);
    drawCube(combine);

    combine = Translate(0.5, 0.5, 0) * Scale(0.3) *RotateX(degrees) * RotateY(degrees);
    drawCube(combine);
    combine = Translate(0.75, 0.75, 0) * Scale(0.3) *RotateX(degrees) * RotateY(degrees);
    drawCube(combine);
    ...
    combine = Translate(0.5, -0.5, 0) * Scale(0.3) *RotateX(degrees) * RotateY(degrees);
    drawCube(combine);
    combine = Translate(0.75, -0.25, 0) * Scale(0.3) *RotateX(degrees) * RotateY(degrees);
    drawCube(combine);
